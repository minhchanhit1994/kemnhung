...
export default function ShopHomepage({ onAdminClick }: ShopHomepageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50/50 via-white to-rose-50/30">
      {/* === Hero Section === */}
      <header className="relative bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-800 text-white overflow-hidden">
        ...
        <div className="max-w-md mx-auto mb-10">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-11 rounded-full border-gray-200 bg-white shadow-sm focus:ring-emerald-500"
            />
          </div>
        </div>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <CardContent className="p-3 md:p-4">
                  ...
                  <p className="text-emerald-700 font-bold text-sm md:text-lg">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-gray-800/80 hover:bg-gray-700 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 backdrop-blur-sm"
          ...
          >
            ...
            <div className="relative aspect-square bg-gray-100 rounded-t-2xl overflow-hidden">
              ...
              <div className="absolute top-3 left-3">
                <Badge className="bg-emerald-600 text-white text-xs px-3 py-1 rounded-full">
                  Còn hàng
                </Badge>
              </div>
            </div>
            ...
            <div className="p-5 md:p-6">
              ...
              <div className="flex items-end justify-between mb-6">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Giá bán</p>
